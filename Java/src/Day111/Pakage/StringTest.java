...
class StringTest {
    public static void main(String[] args) {
        ...
        System.out.println("5. First Name은 arnold이다. (대소문자 미구분; T/F):  " + first.equalsIgnoreCase("anold"));

        System.out.println("6. Last Name " + last + "의 index 번호 6~14까지 문자열 : " +last.substring(6)  ); //14는 없다
//	System.out.println("7. Last Name " + last + "에서 negger 문자열의 위치 : " + );
    }
}